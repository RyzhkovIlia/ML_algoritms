...
from RandomForest import PoissonRandomForestRegressor, PoissonRandomForestClassifier
...
classifier = PoissonRandomForestClassifier(n_estimators=5, min_samples_split=4, max_depth=5)
...
dt_reg = PoissonRandomForestRegressor(n_estimators=5, min_samples_split=4, max_depth=5)
